...
def build_interface():
    ...
    root = Tk()
    root.title('IPv4 host-capacity calculator')
    root.geometry('620x380+80+80')
    root.configure(bg='light green')
    display = StringVar()
    mode_text = StringVar(value='usable_hosts(prefix) · bounded /1…/30')
...
def reset_interface():
    ...
    state['expression'] = '1'
    present_display('1')
    mode_text.set('usable_hosts(prefix) · bounded /1…/30')
