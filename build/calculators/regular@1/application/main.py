...
def build_interface():
    ...
    root.geometry('360x330+330+80')
    root.configure(bg='#e8edf2')
    display = StringVar()
    mode_text = StringVar(value='decimal real · infix')
    Entry(root, textvariable=display, font=('Menlo', 18), justify='right').grid(row=0, column=0, columnspan=4, sticky='nsew')
    Label(root, textvariable=mode_text, bg='#e8edf2', fg='#17202a').grid(row=1, column=0, columnspan=4, sticky='w')
    Button(root, text='7', command=lambda value='7': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=2, column=0, sticky='nsew')
    Button(root, text='8', command=lambda value='8': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=2, column=1, sticky='nsew')
    Button(root, text='9', command=lambda value='9': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=2, column=2, sticky='nsew')
    Button(root, text='÷', command=lambda value='/': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=2, column=3, sticky='nsew')
    Button(root, text='4', command=lambda value='4': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=3, column=0, sticky='nsew')
    Button(root, text='5', command=lambda value='5': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=3, column=1, sticky='nsew')
    Button(root, text='6', command=lambda value='6': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=3, column=2, sticky='nsew')
    Button(root, text='×', command=lambda value='*': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=3, column=3, sticky='nsew')
    Button(root, text='1', command=lambda value='1': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=4, column=0, sticky='nsew')
    Button(root, text='2', command=lambda value='2': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=4, column=1, sticky='nsew')
    Button(root, text='3', command=lambda value='3': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=4, column=2, sticky='nsew')
    Button(root, text='−', command=lambda value='-': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=4, column=3, sticky='nsew')
    Button(root, text='0', command=lambda value='0': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=5, column=0, sticky='nsew')
    Button(root, text='.', command=lambda value='.': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=5, column=1, sticky='nsew')
    Button(root, text='=', command=evaluate, bg='#ffffff', fg='#17202a', width=7).grid(row=5, column=2, sticky='nsew')
    Button(root, text='+', command=lambda value='+': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=5, column=3, sticky='nsew')
    Button(root, text='(', command=lambda value='(': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=6, column=0, sticky='nsew')
    Button(root, text=')', command=lambda value=')': append(value), bg='#ffffff', fg='#17202a', width=7).grid(row=6, column=1, sticky='nsew')
    Button(root, text='⌫', command=backspace, bg='#ffffff', fg='#17202a', width=7).grid(row=6, column=2, sticky='nsew')
    Button(root, text='Clear', command=clear, bg='#ffffff', fg='#17202a', width=7).grid(row=6, column=3, sticky='nsew')
...
def reset_interface():
    ...
    state['expression'] = '1'
    present_display('1')
    mode_text.set('decimal real · infix')
