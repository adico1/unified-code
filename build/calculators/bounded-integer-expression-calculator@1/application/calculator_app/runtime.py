...
try:
    from math_library.library import LIBRARY_IDENTITY, invoke as dependency_invoke
except ImportError:
...
def _expression(spec, request):
    if LIBRARY_IDENTITY != 'e962f575d085938a4a9ddf03173f320fc28951c14ae02d4cc284e3501dffe167':
