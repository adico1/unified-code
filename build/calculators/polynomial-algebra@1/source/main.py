...
FUNCTIONS = {'polynomial': _semantic_0, 'discriminant': _semantic_1}
...
def build_interface():
    ...
    root = Tk()
    root.title('Polynomial algebra calculator')
    root.geometry('620x380+80+80')
    root.configure(bg='light green')
    display = StringVar()
    mode_text = StringVar(value='polynomial(a,b,c,x) · discriminant(a,b,c)')
...
def reset_interface():
    ...
    state['expression'] = '1'
    present_display('1')
    mode_text.set('polynomial(a,b,c,x) · discriminant(a,b,c)')
