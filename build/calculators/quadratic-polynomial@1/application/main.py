...
def _semantic_0(a, b, c, x):
    return (((a * (x ** 2)) + (b * x)) + c)

def _semantic_1(a, b, c):
    return ((b ** 2) - (4 * (a * c)))
...
FUNCTIONS = {'polynomial': _semantic_0, 'discriminant': _semantic_1, 'vertex_x': _semantic_2}
...
def build_interface():
    ...
    display = StringVar()
    mode_text = StringVar(value='signed real · f(x)=ax²+bx+c · Δ=b²−4ac · xᵥ=−b÷2a')
    Entry(root, textvariable=display, font=('Menlo', 18), justify='right').grid(row=0, column=0, columnspan=7, sticky='nsew')
    Label(root, textvariable=mode_text, bg='#eef6ff', fg='#12355b').grid(row=1, column=0, columnspan=7, sticky='w')
    Button(root, text='f(a,b,c,x)', command=lambda value='polynomial(': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=2, column=0, sticky='nsew')
    Button(root, text='Δ(a,b,c)', command=lambda value='discriminant(': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=2, column=1, sticky='nsew')
    Button(root, text='xᵥ(a,b)', command=lambda value='vertex_x(': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=2, column=2, sticky='nsew')
    Button(root, text=',', command=lambda value=',': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=2, column=3, sticky='nsew')
    Button(root, text='(', command=lambda value='(': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=2, column=4, sticky='nsew')
    Button(root, text=')', command=lambda value=')': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=2, column=5, sticky='nsew')
    Button(root, text='C', command=clear, bg='#ffffff', fg='#12355b', width=7).grid(row=2, column=6, sticky='nsew')
    Button(root, text='7', command=lambda value='7': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=3, column=0, sticky='nsew')
    Button(root, text='8', command=lambda value='8': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=3, column=1, sticky='nsew')
    Button(root, text='9', command=lambda value='9': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=3, column=2, sticky='nsew')
    Button(root, text='÷', command=lambda value='/': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=3, column=3, sticky='nsew')
    Button(root, text='×', command=lambda value='*': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=3, column=4, sticky='nsew')
    Button(root, text='^', command=lambda value='**': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=3, column=5, sticky='nsew')
    Button(root, text='⌫', command=backspace, bg='#ffffff', fg='#12355b', width=7).grid(row=3, column=6, sticky='nsew')
    Button(root, text='4', command=lambda value='4': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=4, column=0, sticky='nsew')
    Button(root, text='5', command=lambda value='5': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=4, column=1, sticky='nsew')
    Button(root, text='6', command=lambda value='6': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=4, column=2, sticky='nsew')
    Button(root, text='−', command=lambda value='-': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=4, column=3, sticky='nsew')
    Button(root, text='+', command=lambda value='+': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=4, column=4, sticky='nsew')
    Button(root, text='0', command=lambda value='0': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=4, column=5, sticky='nsew')
    Button(root, text='.', command=lambda value='.': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=4, column=6, sticky='nsew')
    Button(root, text='1', command=lambda value='1': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=5, column=0, sticky='nsew')
    Button(root, text='2', command=lambda value='2': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=5, column=1, sticky='nsew')
    Button(root, text='3', command=lambda value='3': append(value), bg='#ffffff', fg='#12355b', width=7).grid(row=5, column=2, sticky='nsew')
    Button(root, text='=', command=evaluate, bg='#ffffff', fg='#12355b', width=7).grid(row=5, column=6, sticky='nsew')
...
def reset_interface():
    ...
    state['expression'] = '1'
    present_display('1')
    mode_text.set('signed real · f(x)=ax²+bx+c · Δ=b²−4ac · xᵥ=−b÷2a')
...
def self_test_interface(root):
    ...
    reset_interface()
    display.set('polynomial(2,3,4,5)')
    state['expression'] = ''
    widgets = [item for item in root.grid_slaves(row=5, column=6) if item.winfo_class() == 'Button']
    widgets[0].invoke()
    results.append(display.get() == '69')
    reset_interface()
