...
def build_interface():
    ...
    root = Tk()
    root.title('Kinetic-energy arithmetic calculator')
    root.geometry('620x380+80+80')
    root.configure(bg='light green')
    display = StringVar()
    mode_text = StringVar(value='kinetic_energy(mass,velocity)')
...
def reset_interface():
    ...
    state['expression'] = '1'
    present_display('1')
    mode_text.set('kinetic_energy(mass,velocity)')
