...
def build_interface():
    ...
    root = Tk()
    root.title('Compound future-value calculator')
    root.geometry('620x380+80+80')
    root.configure(bg='light green')
    display = StringVar()
    mode_text = StringVar(value='future(principal,rate,periods)')
...
def reset_interface():
    ...
    state['expression'] = '1'
    present_display('1')
    mode_text.set('future(principal,rate,periods)')
