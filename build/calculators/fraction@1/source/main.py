...
FUNCTIONS = {'ratio': _semantic_0, 'reduced_num': _semantic_1, 'reduced_den': _semantic_2}
...
def build_interface():
    ...
    display = StringVar()
    mode_text = StringVar(value='ratio(n,d) · reduced_num(n,d) · reduced_den(n,d)')
...
def reset_interface():
    ...
    state['expression'] = '1'
    present_display('1')
    mode_text.set('ratio(n,d) · reduced_num(n,d) · reduced_den(n,d)')
