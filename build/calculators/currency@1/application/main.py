...
def build_interface():
    ...
    root = Tk()
    root.title('Pinned-rate currency calculator')
    root.geometry('620x380+80+80')
    root.configure(bg='light green')
    display = StringVar()
    mode_text = StringVar(value='usd_to_eur(amount) · pinned example rate 0.92')
...
def reset_interface():
    ...
    state['expression'] = '1'
    present_display('1')
    mode_text.set('usd_to_eur(amount) · pinned example rate 0.92')
