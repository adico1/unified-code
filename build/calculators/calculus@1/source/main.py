...
def build_interface():
    ...
    root = Tk()
    root.title('Bounded polynomial calculus calculator')
    root.geometry('620x380+80+80')
    root.configure(bg='light green')
    display = StringVar()
    mode_text = StringVar(value='derivative(a,b,x) · integral(a,b,c,x)')
...
def reset_interface():
    ...
    state['expression'] = '1'
    present_display('1')
    mode_text.set('derivative(a,b,x) · integral(a,b,c,x)')
