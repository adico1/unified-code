...
def _semantic_1(n, k, probability):
...
FUNCTIONS = {'combinations': _semantic_0, 'binomial': _semantic_1}
...
def build_interface():
    ...
    display = StringVar()
    mode_text = StringVar(value='combinations(n,k) · binomial(n,k,p)')
...
def reset_interface():
    ...
    state['expression'] = '1'
    present_display('1')
    mode_text.set('combinations(n,k) · binomial(n,k,p)')
