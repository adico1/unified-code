...
CASES = [{'id': 'solo.opponent-motion', 'input': {'steps': [{'ticks': 1}]}, 'expected': {'entities': {'left-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 20, 'y': 90}, 'orb': {'height': 10, 'vx': 5, 'vy': 3, 'width': 10, 'x': 200, 'y': 118}, 'right-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 370, 'y': 94}}, 'left_score': 0, 'right_score': 0, 'status': 'playing', 'tick': 1}}]
