...
CASES = [{'id': 'power-up.speed-zone', 'input': {'steps': [{'ticks': 3}]}, 'expected': {'entities': {'left-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 20, 'y': 90}, 'orb': {'height': 10, 'vx': 7.5, 'vy': 3, 'width': 10, 'x': 195, 'y': 124}, 'power-zone': {'height': 100, 'vx': 0, 'vy': 0, 'width': 20, 'x': 200, 'y': 70}, 'right-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 370, 'y': 90}}, 'left_score': 0, 'right_score': 0, 'status': 'playing', 'tick': 3}}]
