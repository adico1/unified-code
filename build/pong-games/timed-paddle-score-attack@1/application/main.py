...
def run_acceptance():
    cases = [{'expected': {'entities': {'left-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 20, 'y': 90}, 'orb': {'height': 10, 'vx': 5, 'vy': 3, 'width': 10, 'x': 250, 'y': 148}, 'right-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 370, 'y': 90}}, 'left_score': 0, 'right_score': 0, 'status': 'finished', 'tick': 11}, 'id': 'timed.deadline', 'input': {'steps': [{'ticks': 11}]}}]
...
def self_test_application():
    ...
    root.withdraw()
    cases = [{'expected': {'entities': {'left-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 20, 'y': 90}, 'orb': {'height': 10, 'vx': 5, 'vy': 3, 'width': 10, 'x': 250, 'y': 148}, 'right-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 370, 'y': 90}}, 'left_score': 0, 'right_score': 0, 'status': 'finished', 'tick': 11}, 'input': {'steps': [{'ticks': 11}]}}]
    checks = []
    for case in cases:
        reset_state()
