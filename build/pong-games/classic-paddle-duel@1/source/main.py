...
APPLICATION_ID = 'uc://applications/classic-paddle-duel@1'
...
def build_interface():
    ...
    _root = Tk()
    _root.title('Classic Paddle Duel')
...
def run_acceptance():
    cases = [{'expected': {'entities': {'left-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 20, 'y': 90}, 'orb': {'height': 10, 'vx': 5, 'vy': 3, 'width': 10, 'x': 200, 'y': 118}, 'right-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 370, 'y': 90}}, 'left_score': 0, 'right_score': 0, 'status': 'playing', 'tick': 1}, 'id': 'classic.motion', 'input': {'steps': [{'ticks': 1}]}}, {'expected': {'entities': {'left-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 20, 'y': 72}, 'orb': {'height': 10, 'vx': 5, 'vy': 3, 'width': 10, 'x': 195, 'y': 115}, 'right-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 370, 'y': 90}}, 'left_score': 0, 'right_score': 0, 'status': 'playing', 'tick': 0}, 'id': 'classic.control', 'input': {'steps': [{'control': 'participant.left.up'}]}}]
...
def self_test_application():
    ...
    root.withdraw()
    cases = [{'expected': {'entities': {'left-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 20, 'y': 72}, 'orb': {'height': 10, 'vx': 5, 'vy': 3, 'width': 10, 'x': 195, 'y': 115}, 'right-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 370, 'y': 90}}, 'left_score': 0, 'right_score': 0, 'status': 'playing', 'tick': 0}, 'input': {'steps': [{'control': 'participant.left.up'}]}}]
    checks = []
    for case in cases:
        reset_state()
