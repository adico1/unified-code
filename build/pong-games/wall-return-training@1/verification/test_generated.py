...
CASES = [{'id': 'wall-training.reflection', 'input': {'steps': [{'ticks': 40}]}, 'expected': {'entities': {'left-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 20, 'y': 90}, 'orb': {'height': 10, 'vx': -5, 'vy': -3, 'width': 10, 'x': 390, 'y': 227}, 'right-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 370, 'y': 90}}, 'left_score': 0, 'right_score': 0, 'status': 'playing', 'tick': 40}}]
EXPECTED_CALLBACKS = ['control_0', 'control_1']
