...
APPLICATION_ID = 'uc://applications/obstacle-paddle-arena@1'
...
INITIAL_STATE = {'entities': {'left-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 20, 'y': 90}, 'orb': {'height': 10, 'vx': 5, 'vy': 3, 'width': 10, 'x': 180, 'y': 115}, 'right-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 370, 'y': 90}, 'center-wall': {'height': 100, 'vx': 0, 'vy': 0, 'width': 10, 'x': 200, 'y': 70}}, 'left_score': 0, 'right_score': 0, 'status': 'playing', 'tick': 0}
...
def advance():
    ...
    if (state['entities']['orb']['x'] < state['entities']['right-bat']['x'] + state['entities']['right-bat']['width'] and state['entities']['orb']['x'] + state['entities']['orb']['width'] > state['entities']['right-bat']['x'] and state['entities']['orb']['y'] < state['entities']['right-bat']['y'] + state['entities']['right-bat']['height'] and state['entities']['orb']['y'] + state['entities']['orb']['height'] > state['entities']['right-bat']['y']):
        state['entities']['orb']['vx'] *= -1
    if (state['entities']['orb']['x'] < state['entities']['center-wall']['x'] + state['entities']['center-wall']['width'] and state['entities']['orb']['x'] + state['entities']['orb']['width'] > state['entities']['center-wall']['x'] and state['entities']['orb']['y'] < state['entities']['center-wall']['y'] + state['entities']['center-wall']['height'] and state['entities']['orb']['y'] + state['entities']['orb']['height'] > state['entities']['center-wall']['y']):
        state['entities']['orb']['vx'] *= -1
...
def present_state():
    ...
    _surface.create_rectangle(state['entities']['center-wall']['x'], state['entities']['center-wall']['y'], state['entities']['center-wall']['x'] + state['entities']['center-wall']['width'], state['entities']['center-wall']['y'] + state['entities']['center-wall']['height'], fill='orange', outline='orange')
...
def build_interface():
    ...
    _root = Tk()
    _root.title('Obstacle Paddle Arena')
...
def run_acceptance():
    cases = [{'expected': {'entities': {'center-wall': {'height': 100, 'vx': 0, 'vy': 0, 'width': 10, 'x': 200, 'y': 70}, 'left-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 20, 'y': 90}, 'orb': {'height': 10, 'vx': -5, 'vy': 3, 'width': 10, 'x': 195, 'y': 124}, 'right-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 370, 'y': 90}}, 'left_score': 0, 'right_score': 0, 'status': 'playing', 'tick': 3}, 'id': 'obstacle.center-reflection', 'input': {'steps': [{'ticks': 3}]}}]
...
def self_test_application():
    ...
    root.withdraw()
    cases = [{'expected': {'entities': {'center-wall': {'height': 100, 'vx': 0, 'vy': 0, 'width': 10, 'x': 200, 'y': 70}, 'left-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 20, 'y': 90}, 'orb': {'height': 10, 'vx': -5, 'vy': 3, 'width': 10, 'x': 195, 'y': 124}, 'right-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 370, 'y': 90}}, 'left_score': 0, 'right_score': 0, 'status': 'playing', 'tick': 3}, 'input': {'steps': [{'ticks': 3}]}}]
    checks = []
    for case in cases:
        reset_state()
