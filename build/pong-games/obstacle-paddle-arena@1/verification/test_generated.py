...
CASES = [{'id': 'obstacle.center-reflection', 'input': {'steps': [{'ticks': 3}]}, 'expected': {'entities': {'center-wall': {'height': 100, 'vx': 0, 'vy': 0, 'width': 10, 'x': 200, 'y': 70}, 'left-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 20, 'y': 90}, 'orb': {'height': 10, 'vx': -5, 'vy': 3, 'width': 10, 'x': 195, 'y': 124}, 'right-bat': {'height': 60, 'vx': 0, 'vy': 0, 'width': 10, 'x': 370, 'y': 90}}, 'left_score': 0, 'right_score': 0, 'status': 'playing', 'tick': 3}}]
