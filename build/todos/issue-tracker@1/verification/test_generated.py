...
CASES = [{'id': 'issue-tracker.lifecycle', 'input': {'steps': [{'arguments': {'assignee_field': 'assignee_field-value', 'discussion_field': 'discussion_field-value', 'labels_field': 'labels_field-value', 'status_field': 'status_field-value', 'title': 'A'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}, 'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'assignee_field': 'assignee_field-value', 'completed': False, 'discussion_field': 'discussion_field-value', 'id': 1, 'labels_field': 'labels_field-value', 'status_field': 'status_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'assignee_field': 'assignee_field-value', 'completed': True, 'discussion_field': 'discussion_field-value', 'id': 1, 'labels_field': 'labels_field-value', 'status_field': 'status_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'assignee_field': 'assignee_field-value', 'completed': True, 'discussion_field': 'discussion_field-value', 'id': 1, 'labels_field': 'labels_field-value', 'status_field': 'status_field-value', 'title': 'A'}]}}], 'state': {'filter': 'all', 'next_id': 2, 'records': [{'assignee_field': 'assignee_field-value', 'completed': True, 'discussion_field': 'discussion_field-value', 'id': 1, 'labels_field': 'labels_field-value', 'status_field': 'status_field-value', 'title': 'A'}]}}}]
