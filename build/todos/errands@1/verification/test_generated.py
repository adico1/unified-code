...
CASES = [{'id': 'errands.lifecycle', 'input': {'steps': [{'arguments': {'completion_state_field': 'completion_state_field-value', 'location_field': 'location_field-value', 'route_order_field': 'route_order_field-value', 'title': 'A'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}, 'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'completion_state_field': 'completion_state_field-value', 'id': 1, 'location_field': 'location_field-value', 'route_order_field': 'route_order_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'completion_state_field': 'completion_state_field-value', 'id': 1, 'location_field': 'location_field-value', 'route_order_field': 'route_order_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'completion_state_field': 'completion_state_field-value', 'id': 1, 'location_field': 'location_field-value', 'route_order_field': 'route_order_field-value', 'title': 'A'}]}}], 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'completion_state_field': 'completion_state_field-value', 'id': 1, 'location_field': 'location_field-value', 'route_order_field': 'route_order_field-value', 'title': 'A'}]}}}]
