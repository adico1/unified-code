...
APPLICATION_ID = 'uc://applications/grocery@1'
...
IDENTITY_FIELD = 'id'
DISPLAY_FIELDS = ['id', 'title', 'item_quantity_field', 'store_section_field', 'purchased_state_field', 'completed']
FILTER_FIELD = 'filter'
FILTERS = {'all': None, 'completed': {'equals': True, 'field': 'completed'}, 'open': {'equals': False, 'field': 'completed'}}
VISIBILITY = None
DEFAULT_STATE_PATH = '.unified-code-manual/grocery/state.json'
STATE_ENVIRONMENT = 'UC_MANUAL_GROCERY_STATE'
...
def command_create(arguments):
    ...
    if 'item_quantity_field' not in arguments:
        return _failure('missing-item_quantity_field')
    if 'store_section_field' not in arguments:
        return _failure('missing-store_section_field')
    if 'purchased_state_field' not in arguments:
        return _failure('missing-purchased_state_field')
    ...
    state['records'].append({'completed': False, 'id': state['next_id'], 'item_quantity_field': arguments['item_quantity_field'], 'purchased_state_field': arguments['purchased_state_field'], 'store_section_field': arguments['store_section_field'], 'title': arguments['title']})
    state['next_id'] += 1
    persist_state()
    present_state()
    return _success()
...
def command_update(arguments):
    ...
    for record in state['records']:
        if record['id'] == arguments['id']:
            record['item_quantity_field'] = arguments['item_quantity_field']
            record['purchased_state_field'] = arguments['purchased_state_field']
            record['store_section_field'] = arguments['store_section_field']
...
def control_0():
    ...
    _last_outcome = command_create({'item_quantity_field': _inputs['entry.item_quantity_field'].get(), 'purchased_state_field': _inputs['entry.purchased_state_field'].get(), 'store_section_field': _inputs['entry.store_section_field'].get(), 'title': _inputs['entry.primary'].get()})
    _status.set(_last_outcome['error'] or 'ok')
    return _last_outcome

def control_1():
    global _last_outcome
    _last_outcome = command_update({'id': selected_value('collection.primary', 'id'), 'item_quantity_field': _inputs['entry.item_quantity_field'].get(), 'purchased_state_field': _inputs['entry.purchased_state_field'].get(), 'store_section_field': _inputs['entry.store_section_field'].get(), 'title': _inputs['entry.primary'].get()})
    _status.set(_last_outcome['error'] or 'ok')
    return _last_outcome
...
def build_interface():
    ...
    Label(_root, text='Item Quantity Field').grid(row=1, column=0, sticky='w')
    _inputs['entry.item_quantity_field'] = Entry(_root, width=38)
    _inputs['entry.item_quantity_field'].grid(row=1, column=1, columnspan=3, sticky='ew')
    Label(_root, text='Store Section Field').grid(row=2, column=0, sticky='w')
    _inputs['entry.store_section_field'] = Entry(_root, width=38)
    _inputs['entry.store_section_field'].grid(row=2, column=1, columnspan=3, sticky='ew')
    Label(_root, text='Purchased State Field').grid(row=3, column=0, sticky='w')
    _inputs['entry.purchased_state_field'] = Entry(_root, width=38)
    _inputs['entry.purchased_state_field'].grid(row=3, column=1, columnspan=3, sticky='ew')
...
def run_acceptance():
    cases = [{'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'id': 1, 'item_quantity_field': 'item_quantity_field-value', 'purchased_state_field': 'purchased_state_field-value', 'store_section_field': 'store_section_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'id': 1, 'item_quantity_field': 'item_quantity_field-value', 'purchased_state_field': 'purchased_state_field-value', 'store_section_field': 'store_section_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'id': 1, 'item_quantity_field': 'item_quantity_field-value', 'purchased_state_field': 'purchased_state_field-value', 'store_section_field': 'store_section_field-value', 'title': 'A'}]}}], 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'id': 1, 'item_quantity_field': 'item_quantity_field-value', 'purchased_state_field': 'purchased_state_field-value', 'store_section_field': 'store_section_field-value', 'title': 'A'}]}}, 'id': 'grocery.lifecycle', 'input': {'steps': [{'arguments': {'item_quantity_field': 'item_quantity_field-value', 'purchased_state_field': 'purchased_state_field-value', 'store_section_field': 'store_section_field-value', 'title': 'A'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}}]
...
def self_test_interface():
    ...
    with tempfile.TemporaryDirectory(prefix='generated-stateful-gui-') as directory:
        ...
        root.withdraw()
        cases = [{'control': 'record.create', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'id': 1, 'item_quantity_field': 'item_quantity_field-value', 'purchased_state_field': 'purchased_state_field-value', 'store_section_field': 'store_section_field-value', 'title': 'A'}]}}, 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'id': 1, 'item_quantity_field': 'item_quantity_field-value', 'purchased_state_field': 'purchased_state_field-value', 'store_section_field': 'store_section_field-value', 'title': 'A'}]}}, 'inputs': {'entry.item_quantity_field': 'item_quantity_field-value', 'entry.primary': 'A', 'entry.purchased_state_field': 'purchased_state_field-value', 'entry.store_section_field': 'store_section_field-value'}}, {'control': 'record.update', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'id': 1, 'item_quantity_field': 'item_quantity_field-value', 'purchased_state_field': 'purchased_state_field-value', 'store_section_field': 'store_section_field-value', 'title': 'B'}]}}, 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'id': 1, 'item_quantity_field': 'item_quantity_field-value', 'purchased_state_field': 'purchased_state_field-value', 'store_section_field': 'store_section_field-value', 'title': 'B'}]}}, 'inputs': {'entry.item_quantity_field': 'item_quantity_field-value', 'entry.primary': 'B', 'entry.purchased_state_field': 'purchased_state_field-value', 'entry.store_section_field': 'store_section_field-value'}, 'selection': {'identity': 'collection.primary', 'index': 0}, 'setup': [{'arguments': {'item_quantity_field': 'item_quantity_field-value', 'purchased_state_field': 'purchased_state_field-value', 'store_section_field': 'store_section_field-value', 'title': 'A'}, 'command': 'create'}]}, {'control': 'record.toggle', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'id': 1, 'item_quantity_field': 'item_quantity_field-value', 'purchased_state_field': 'purchased_state_field-value', 'store_section_field': 'store_section_field-value', 'title': 'A'}]}}, 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'id': 1, 'item_quantity_field': 'item_quantity_field-value', 'purchased_state_field': 'purchased_state_field-value', 'store_section_field': 'store_section_field-value', 'title': 'A'}]}}, 'selection': {'identity': 'collection.primary', 'index': 0}, 'setup': [{'arguments': {'item_quantity_field': 'item_quantity_field-value', 'purchased_state_field': 'purchased_state_field-value', 'store_section_field': 'store_section_field-value', 'title': 'A'}, 'command': 'create'}]}, {'control': 'record.remove', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': []}}, 'state': {'filter': 'all', 'next_id': 2, 'records': []}}, 'selection': {'identity': 'collection.primary', 'index': 0}, 'setup': [{'arguments': {'item_quantity_field': 'item_quantity_field-value', 'purchased_state_field': 'purchased_state_field-value', 'store_section_field': 'store_section_field-value', 'title': 'A'}, 'command': 'create'}]}, {'control': 'filter.all', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 1, 'records': []}}, 'state': {'filter': 'all', 'next_id': 1, 'records': []}}}, {'control': 'filter.open', 'expected': {'outcome': {'error': None, 'result': {'filter': 'open', 'next_id': 1, 'records': []}}, 'state': {'filter': 'open', 'next_id': 1, 'records': []}}}, {'control': 'filter.completed', 'expected': {'outcome': {'error': None, 'result': {'filter': 'completed', 'next_id': 1, 'records': []}}, 'state': {'filter': 'completed', 'next_id': 1, 'records': []}}}]
        for case in cases:
            outward.clear()
            reset_state()
