...
CASES = [{'id': 'calendar-tasks.lifecycle', 'input': {'steps': [{'arguments': {'calendar_placement_field': 'calendar_placement_field-value', 'due_at_field': 'due_at_field-value', 'start_at_field': 'start_at_field-value', 'title': 'A'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}, 'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'calendar_placement_field': 'calendar_placement_field-value', 'completed': False, 'due_at_field': 'due_at_field-value', 'id': 1, 'start_at_field': 'start_at_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'calendar_placement_field': 'calendar_placement_field-value', 'completed': True, 'due_at_field': 'due_at_field-value', 'id': 1, 'start_at_field': 'start_at_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'calendar_placement_field': 'calendar_placement_field-value', 'completed': True, 'due_at_field': 'due_at_field-value', 'id': 1, 'start_at_field': 'start_at_field-value', 'title': 'A'}]}}], 'state': {'filter': 'all', 'next_id': 2, 'records': [{'calendar_placement_field': 'calendar_placement_field-value', 'completed': True, 'due_at_field': 'due_at_field-value', 'id': 1, 'start_at_field': 'start_at_field-value', 'title': 'A'}]}}}]
