...
CASES = [{'id': 'sprint-backlog.lifecycle', 'input': {'steps': [{'arguments': {'estimate_field': 'estimate_field-value', 'sprint_field': 'sprint_field-value', 'title': 'A', 'workflow_state_field': 'workflow_state_field-value'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}, 'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'estimate_field': 'estimate_field-value', 'id': 1, 'sprint_field': 'sprint_field-value', 'title': 'A', 'workflow_state_field': 'workflow_state_field-value'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'estimate_field': 'estimate_field-value', 'id': 1, 'sprint_field': 'sprint_field-value', 'title': 'A', 'workflow_state_field': 'workflow_state_field-value'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'estimate_field': 'estimate_field-value', 'id': 1, 'sprint_field': 'sprint_field-value', 'title': 'A', 'workflow_state_field': 'workflow_state_field-value'}]}}], 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'estimate_field': 'estimate_field-value', 'id': 1, 'sprint_field': 'sprint_field-value', 'title': 'A', 'workflow_state_field': 'workflow_state_field-value'}]}}}]
