...
CASES = [{'id': 'reminders.lifecycle', 'input': {'steps': [{'arguments': {'acknowledgement_field': 'acknowledgement_field-value', 'due_at_field': 'due_at_field-value', 'notification_state_field': 'notification_state_field-value', 'title': 'A'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}, 'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'acknowledgement_field': 'acknowledgement_field-value', 'completed': False, 'due_at_field': 'due_at_field-value', 'id': 1, 'notification_state_field': 'notification_state_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'acknowledgement_field': 'acknowledgement_field-value', 'completed': True, 'due_at_field': 'due_at_field-value', 'id': 1, 'notification_state_field': 'notification_state_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'acknowledgement_field': 'acknowledgement_field-value', 'completed': True, 'due_at_field': 'due_at_field-value', 'id': 1, 'notification_state_field': 'notification_state_field-value', 'title': 'A'}]}}], 'state': {'filter': 'all', 'next_id': 2, 'records': [{'acknowledgement_field': 'acknowledgement_field-value', 'completed': True, 'due_at_field': 'due_at_field-value', 'id': 1, 'notification_state_field': 'notification_state_field-value', 'title': 'A'}]}}}]
