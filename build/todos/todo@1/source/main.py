...
APPLICATION_ID = 'uc://applications/todo@1'
...
VISIBILITY = None
DEFAULT_STATE_PATH = '.unified-code-manual/todo/state.json'
STATE_ENVIRONMENT = 'UC_MANUAL_TODO_STATE'
...
def run_acceptance():
    cases = [{'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'tasks': [{'completed': False, 'id': 1, 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 3, 'tasks': [{'completed': False, 'id': 1, 'title': 'A'}, {'completed': False, 'id': 2, 'title': 'B'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 3, 'tasks': [{'completed': True, 'id': 1, 'title': 'A'}, {'completed': False, 'id': 2, 'title': 'B'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 3, 'tasks': [{'completed': True, 'id': 1, 'title': 'A'}, {'completed': False, 'id': 2, 'title': 'B'}]}}], 'state': {'filter': 'all', 'next_id': 3, 'tasks': [{'completed': True, 'id': 1, 'title': 'A'}, {'completed': False, 'id': 2, 'title': 'B'}]}}, 'id': 'todo.persisted-lifecycle', 'input': {'steps': [{'arguments': {'title': 'A'}, 'command': 'create'}, {'arguments': {'title': 'B'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}}, {'expected': {'results': [{'error': 'invalid-title', 'result': None}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'tasks': [{'completed': False, 'id': 1, 'title': 'A'}]}}, {'error': 'duplicate-title', 'result': None}, {'error': 'unknown-item', 'result': None}], 'state': {'filter': 'all', 'next_id': 2, 'tasks': [{'completed': False, 'id': 1, 'title': 'A'}]}}, 'id': 'todo.validation', 'input': {'steps': [{'arguments': {'title': ' '}, 'command': 'create'}, {'arguments': {'title': 'A'}, 'command': 'create'}, {'arguments': {'title': 'A'}, 'command': 'create'}, {'arguments': {'id': 99}, 'command': 'remove'}]}}]
