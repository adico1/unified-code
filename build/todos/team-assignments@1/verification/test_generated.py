...
CASES = [{'id': 'team-assignments.lifecycle', 'input': {'steps': [{'arguments': {'assignee_field': 'assignee_field-value', 'handoff_field': 'handoff_field-value', 'ownership_field': 'ownership_field-value', 'title': 'A'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}, 'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'assignee_field': 'assignee_field-value', 'completed': False, 'handoff_field': 'handoff_field-value', 'id': 1, 'ownership_field': 'ownership_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'assignee_field': 'assignee_field-value', 'completed': True, 'handoff_field': 'handoff_field-value', 'id': 1, 'ownership_field': 'ownership_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'assignee_field': 'assignee_field-value', 'completed': True, 'handoff_field': 'handoff_field-value', 'id': 1, 'ownership_field': 'ownership_field-value', 'title': 'A'}]}}], 'state': {'filter': 'all', 'next_id': 2, 'records': [{'assignee_field': 'assignee_field-value', 'completed': True, 'handoff_field': 'handoff_field-value', 'id': 1, 'ownership_field': 'ownership_field-value', 'title': 'A'}]}}}]
