...
CASES = [{'id': 'gtd.lifecycle', 'input': {'steps': [{'arguments': {'context_field': 'context_field-value', 'inbox_field': 'inbox_field-value', 'next_action_field': 'next_action_field-value', 'review_state_field': 'review_state_field-value', 'title': 'A'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}, 'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'context_field': 'context_field-value', 'id': 1, 'inbox_field': 'inbox_field-value', 'next_action_field': 'next_action_field-value', 'review_state_field': 'review_state_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'context_field': 'context_field-value', 'id': 1, 'inbox_field': 'inbox_field-value', 'next_action_field': 'next_action_field-value', 'review_state_field': 'review_state_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'context_field': 'context_field-value', 'id': 1, 'inbox_field': 'inbox_field-value', 'next_action_field': 'next_action_field-value', 'review_state_field': 'review_state_field-value', 'title': 'A'}]}}], 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'context_field': 'context_field-value', 'id': 1, 'inbox_field': 'inbox_field-value', 'next_action_field': 'next_action_field-value', 'review_state_field': 'review_state_field-value', 'title': 'A'}]}}}]
