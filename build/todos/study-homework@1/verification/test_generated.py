...
CASES = [{'id': 'study-homework.lifecycle', 'input': {'steps': [{'arguments': {'course_field': 'course_field-value', 'due_at_field': 'due_at_field-value', 'study_state_field': 'study_state_field-value', 'title': 'A'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}, 'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'course_field': 'course_field-value', 'due_at_field': 'due_at_field-value', 'id': 1, 'study_state_field': 'study_state_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'course_field': 'course_field-value', 'due_at_field': 'due_at_field-value', 'id': 1, 'study_state_field': 'study_state_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'course_field': 'course_field-value', 'due_at_field': 'due_at_field-value', 'id': 1, 'study_state_field': 'study_state_field-value', 'title': 'A'}]}}], 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'course_field': 'course_field-value', 'due_at_field': 'due_at_field-value', 'id': 1, 'study_state_field': 'study_state_field-value', 'title': 'A'}]}}}]
