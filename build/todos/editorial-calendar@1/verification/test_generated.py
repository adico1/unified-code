...
CASES = [{'id': 'editorial-calendar.lifecycle', 'input': {'steps': [{'arguments': {'content_stage_field': 'content_stage_field-value', 'editor_field': 'editor_field-value', 'publish_at_field': 'publish_at_field-value', 'title': 'A'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}, 'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'content_stage_field': 'content_stage_field-value', 'editor_field': 'editor_field-value', 'id': 1, 'publish_at_field': 'publish_at_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'content_stage_field': 'content_stage_field-value', 'editor_field': 'editor_field-value', 'id': 1, 'publish_at_field': 'publish_at_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'content_stage_field': 'content_stage_field-value', 'editor_field': 'editor_field-value', 'id': 1, 'publish_at_field': 'publish_at_field-value', 'title': 'A'}]}}], 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'content_stage_field': 'content_stage_field-value', 'editor_field': 'editor_field-value', 'id': 1, 'publish_at_field': 'publish_at_field-value', 'title': 'A'}]}}}]
