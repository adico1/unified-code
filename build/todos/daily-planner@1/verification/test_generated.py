...
CASES = [{'id': 'daily-planner.lifecycle', 'input': {'steps': [{'arguments': {'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'time_block_field': 'time_block_field-value', 'title': 'A'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}, 'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'id': 1, 'time_block_field': 'time_block_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'id': 1, 'time_block_field': 'time_block_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'id': 1, 'time_block_field': 'time_block_field-value', 'title': 'A'}]}}], 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'id': 1, 'time_block_field': 'time_block_field-value', 'title': 'A'}]}}}]
