...
APPLICATION_ID = 'uc://applications/daily-planner@1'
...
IDENTITY_FIELD = 'id'
DISPLAY_FIELDS = ['id', 'title', 'time_block_field', 'daily_order_field', 'completion_state_field', 'completed']
FILTER_FIELD = 'filter'
FILTERS = {'all': None, 'completed': {'equals': True, 'field': 'completed'}, 'open': {'equals': False, 'field': 'completed'}}
VISIBILITY = None
DEFAULT_STATE_PATH = '.unified-code-manual/daily-planner/state.json'
STATE_ENVIRONMENT = 'UC_MANUAL_DAILY_PLANNER_STATE'
...
def command_create(arguments):
    ...
    if 'time_block_field' not in arguments:
        return _failure('missing-time_block_field')
    if 'daily_order_field' not in arguments:
        return _failure('missing-daily_order_field')
    ...
    state['records'].append({'completed': False, 'completion_state_field': arguments['completion_state_field'], 'daily_order_field': arguments['daily_order_field'], 'id': state['next_id'], 'time_block_field': arguments['time_block_field'], 'title': arguments['title']})
    state['next_id'] += 1
    persist_state()
    present_state()
    return _success()
...
def command_update(arguments):
    ...
    for record in state['records']:
        if record['id'] == arguments['id']:
            ...
            record['daily_order_field'] = arguments['daily_order_field']
            record['time_block_field'] = arguments['time_block_field']
...
def control_0():
    ...
    _last_outcome = command_create({'completion_state_field': _inputs['entry.completion_state_field'].get(), 'daily_order_field': _inputs['entry.daily_order_field'].get(), 'time_block_field': _inputs['entry.time_block_field'].get(), 'title': _inputs['entry.primary'].get()})
    _status.set(_last_outcome['error'] or 'ok')
    return _last_outcome

def control_1():
    global _last_outcome
    _last_outcome = command_update({'completion_state_field': _inputs['entry.completion_state_field'].get(), 'daily_order_field': _inputs['entry.daily_order_field'].get(), 'id': selected_value('collection.primary', 'id'), 'time_block_field': _inputs['entry.time_block_field'].get(), 'title': _inputs['entry.primary'].get()})
    _status.set(_last_outcome['error'] or 'ok')
    return _last_outcome
...
def build_interface():
    ...
    Label(_root, text='Time Block Field').grid(row=1, column=0, sticky='w')
    _inputs['entry.time_block_field'] = Entry(_root, width=38)
    _inputs['entry.time_block_field'].grid(row=1, column=1, columnspan=3, sticky='ew')
    Label(_root, text='Daily Order Field').grid(row=2, column=0, sticky='w')
    _inputs['entry.daily_order_field'] = Entry(_root, width=38)
    _inputs['entry.daily_order_field'].grid(row=2, column=1, columnspan=3, sticky='ew')
...
def run_acceptance():
    cases = [{'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'id': 1, 'time_block_field': 'time_block_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'id': 1, 'time_block_field': 'time_block_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'id': 1, 'time_block_field': 'time_block_field-value', 'title': 'A'}]}}], 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'id': 1, 'time_block_field': 'time_block_field-value', 'title': 'A'}]}}, 'id': 'daily-planner.lifecycle', 'input': {'steps': [{'arguments': {'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'time_block_field': 'time_block_field-value', 'title': 'A'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}}]
...
def self_test_interface():
    ...
    with tempfile.TemporaryDirectory(prefix='generated-stateful-gui-') as directory:
        ...
        root.withdraw()
        cases = [{'control': 'record.create', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'id': 1, 'time_block_field': 'time_block_field-value', 'title': 'A'}]}}, 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'id': 1, 'time_block_field': 'time_block_field-value', 'title': 'A'}]}}, 'inputs': {'entry.completion_state_field': 'completion_state_field-value', 'entry.daily_order_field': 'daily_order_field-value', 'entry.primary': 'A', 'entry.time_block_field': 'time_block_field-value'}}, {'control': 'record.update', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'id': 1, 'time_block_field': 'time_block_field-value', 'title': 'B'}]}}, 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'id': 1, 'time_block_field': 'time_block_field-value', 'title': 'B'}]}}, 'inputs': {'entry.completion_state_field': 'completion_state_field-value', 'entry.daily_order_field': 'daily_order_field-value', 'entry.primary': 'B', 'entry.time_block_field': 'time_block_field-value'}, 'selection': {'identity': 'collection.primary', 'index': 0}, 'setup': [{'arguments': {'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'time_block_field': 'time_block_field-value', 'title': 'A'}, 'command': 'create'}]}, {'control': 'record.toggle', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'id': 1, 'time_block_field': 'time_block_field-value', 'title': 'A'}]}}, 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'id': 1, 'time_block_field': 'time_block_field-value', 'title': 'A'}]}}, 'selection': {'identity': 'collection.primary', 'index': 0}, 'setup': [{'arguments': {'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'time_block_field': 'time_block_field-value', 'title': 'A'}, 'command': 'create'}]}, {'control': 'record.remove', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': []}}, 'state': {'filter': 'all', 'next_id': 2, 'records': []}}, 'selection': {'identity': 'collection.primary', 'index': 0}, 'setup': [{'arguments': {'completion_state_field': 'completion_state_field-value', 'daily_order_field': 'daily_order_field-value', 'time_block_field': 'time_block_field-value', 'title': 'A'}, 'command': 'create'}]}, {'control': 'filter.all', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 1, 'records': []}}, 'state': {'filter': 'all', 'next_id': 1, 'records': []}}}, {'control': 'filter.open', 'expected': {'outcome': {'error': None, 'result': {'filter': 'open', 'next_id': 1, 'records': []}}, 'state': {'filter': 'open', 'next_id': 1, 'records': []}}}, {'control': 'filter.completed', 'expected': {'outcome': {'error': None, 'result': {'filter': 'completed', 'next_id': 1, 'records': []}}, 'state': {'filter': 'completed', 'next_id': 1, 'records': []}}}]
        for case in cases:
            outward.clear()
            reset_state()
