...
APPLICATION_ID = 'uc://applications/kanban@1'
...
IDENTITY_FIELD = 'id'
DISPLAY_FIELDS = ['id', 'title', 'column_state_field', 'work_in_progress_limit_field', 'card_order_field', 'completed']
FILTER_FIELD = 'filter'
FILTERS = {'all': None, 'completed': {'equals': True, 'field': 'completed'}, 'open': {'equals': False, 'field': 'completed'}}
VISIBILITY = None
DEFAULT_STATE_PATH = '.unified-code-manual/kanban/state.json'
STATE_ENVIRONMENT = 'UC_MANUAL_KANBAN_STATE'
...
def command_create(arguments):
    ...
    if 'column_state_field' not in arguments:
        return _failure('missing-column_state_field')
    if 'work_in_progress_limit_field' not in arguments:
        return _failure('missing-work_in_progress_limit_field')
    if 'card_order_field' not in arguments:
        return _failure('missing-card_order_field')
    ...
    state['records'].append({'card_order_field': arguments['card_order_field'], 'column_state_field': arguments['column_state_field'], 'completed': False, 'id': state['next_id'], 'title': arguments['title'], 'work_in_progress_limit_field': arguments['work_in_progress_limit_field']})
    state['next_id'] += 1
    persist_state()
    present_state()
    return _success()
...
def command_update(arguments):
    ...
    for record in state['records']:
        if record['id'] == arguments['id']:
            record['card_order_field'] = arguments['card_order_field']
            record['column_state_field'] = arguments['column_state_field']
            record['title'] = arguments['title']
            record['work_in_progress_limit_field'] = arguments['work_in_progress_limit_field']
    persist_state()
    present_state()
    return _success()
...
def control_0():
    ...
    _last_outcome = command_create({'card_order_field': _inputs['entry.card_order_field'].get(), 'column_state_field': _inputs['entry.column_state_field'].get(), 'title': _inputs['entry.primary'].get(), 'work_in_progress_limit_field': _inputs['entry.work_in_progress_limit_field'].get()})
    _status.set(_last_outcome['error'] or 'ok')
    return _last_outcome

def control_1():
    global _last_outcome
    _last_outcome = command_update({'card_order_field': _inputs['entry.card_order_field'].get(), 'column_state_field': _inputs['entry.column_state_field'].get(), 'id': selected_value('collection.primary', 'id'), 'title': _inputs['entry.primary'].get(), 'work_in_progress_limit_field': _inputs['entry.work_in_progress_limit_field'].get()})
    _status.set(_last_outcome['error'] or 'ok')
    return _last_outcome
...
def build_interface():
    ...
    Label(_root, text='Column State Field').grid(row=1, column=0, sticky='w')
    _inputs['entry.column_state_field'] = Entry(_root, width=38)
    _inputs['entry.column_state_field'].grid(row=1, column=1, columnspan=3, sticky='ew')
    Label(_root, text='Work In Progress Limit Field').grid(row=2, column=0, sticky='w')
    _inputs['entry.work_in_progress_limit_field'] = Entry(_root, width=38)
    _inputs['entry.work_in_progress_limit_field'].grid(row=2, column=1, columnspan=3, sticky='ew')
    Label(_root, text='Card Order Field').grid(row=3, column=0, sticky='w')
    _inputs['entry.card_order_field'] = Entry(_root, width=38)
    _inputs['entry.card_order_field'].grid(row=3, column=1, columnspan=3, sticky='ew')
...
def run_acceptance():
    cases = [{'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'card_order_field': 'card_order_field-value', 'column_state_field': 'column_state_field-value', 'completed': False, 'id': 1, 'title': 'A', 'work_in_progress_limit_field': 'work_in_progress_limit_field-value'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'card_order_field': 'card_order_field-value', 'column_state_field': 'column_state_field-value', 'completed': True, 'id': 1, 'title': 'A', 'work_in_progress_limit_field': 'work_in_progress_limit_field-value'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'card_order_field': 'card_order_field-value', 'column_state_field': 'column_state_field-value', 'completed': True, 'id': 1, 'title': 'A', 'work_in_progress_limit_field': 'work_in_progress_limit_field-value'}]}}], 'state': {'filter': 'all', 'next_id': 2, 'records': [{'card_order_field': 'card_order_field-value', 'column_state_field': 'column_state_field-value', 'completed': True, 'id': 1, 'title': 'A', 'work_in_progress_limit_field': 'work_in_progress_limit_field-value'}]}}, 'id': 'kanban.lifecycle', 'input': {'steps': [{'arguments': {'card_order_field': 'card_order_field-value', 'column_state_field': 'column_state_field-value', 'title': 'A', 'work_in_progress_limit_field': 'work_in_progress_limit_field-value'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}}]
...
def self_test_interface():
    ...
    with tempfile.TemporaryDirectory(prefix='generated-stateful-gui-') as directory:
        ...
        root.withdraw()
        cases = [{'control': 'record.create', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'card_order_field': 'card_order_field-value', 'column_state_field': 'column_state_field-value', 'completed': False, 'id': 1, 'title': 'A', 'work_in_progress_limit_field': 'work_in_progress_limit_field-value'}]}}, 'state': {'filter': 'all', 'next_id': 2, 'records': [{'card_order_field': 'card_order_field-value', 'column_state_field': 'column_state_field-value', 'completed': False, 'id': 1, 'title': 'A', 'work_in_progress_limit_field': 'work_in_progress_limit_field-value'}]}}, 'inputs': {'entry.card_order_field': 'card_order_field-value', 'entry.column_state_field': 'column_state_field-value', 'entry.primary': 'A', 'entry.work_in_progress_limit_field': 'work_in_progress_limit_field-value'}}, {'control': 'record.update', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'card_order_field': 'card_order_field-value', 'column_state_field': 'column_state_field-value', 'completed': False, 'id': 1, 'title': 'B', 'work_in_progress_limit_field': 'work_in_progress_limit_field-value'}]}}, 'state': {'filter': 'all', 'next_id': 2, 'records': [{'card_order_field': 'card_order_field-value', 'column_state_field': 'column_state_field-value', 'completed': False, 'id': 1, 'title': 'B', 'work_in_progress_limit_field': 'work_in_progress_limit_field-value'}]}}, 'inputs': {'entry.card_order_field': 'card_order_field-value', 'entry.column_state_field': 'column_state_field-value', 'entry.primary': 'B', 'entry.work_in_progress_limit_field': 'work_in_progress_limit_field-value'}, 'selection': {'identity': 'collection.primary', 'index': 0}, 'setup': [{'arguments': {'card_order_field': 'card_order_field-value', 'column_state_field': 'column_state_field-value', 'title': 'A', 'work_in_progress_limit_field': 'work_in_progress_limit_field-value'}, 'command': 'create'}]}, {'control': 'record.toggle', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'card_order_field': 'card_order_field-value', 'column_state_field': 'column_state_field-value', 'completed': True, 'id': 1, 'title': 'A', 'work_in_progress_limit_field': 'work_in_progress_limit_field-value'}]}}, 'state': {'filter': 'all', 'next_id': 2, 'records': [{'card_order_field': 'card_order_field-value', 'column_state_field': 'column_state_field-value', 'completed': True, 'id': 1, 'title': 'A', 'work_in_progress_limit_field': 'work_in_progress_limit_field-value'}]}}, 'selection': {'identity': 'collection.primary', 'index': 0}, 'setup': [{'arguments': {'card_order_field': 'card_order_field-value', 'column_state_field': 'column_state_field-value', 'title': 'A', 'work_in_progress_limit_field': 'work_in_progress_limit_field-value'}, 'command': 'create'}]}, {'control': 'record.remove', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': []}}, 'state': {'filter': 'all', 'next_id': 2, 'records': []}}, 'selection': {'identity': 'collection.primary', 'index': 0}, 'setup': [{'arguments': {'card_order_field': 'card_order_field-value', 'column_state_field': 'column_state_field-value', 'title': 'A', 'work_in_progress_limit_field': 'work_in_progress_limit_field-value'}, 'command': 'create'}]}, {'control': 'filter.all', 'expected': {'outcome': {'error': None, 'result': {'filter': 'all', 'next_id': 1, 'records': []}}, 'state': {'filter': 'all', 'next_id': 1, 'records': []}}}, {'control': 'filter.open', 'expected': {'outcome': {'error': None, 'result': {'filter': 'open', 'next_id': 1, 'records': []}}, 'state': {'filter': 'open', 'next_id': 1, 'records': []}}}, {'control': 'filter.completed', 'expected': {'outcome': {'error': None, 'result': {'filter': 'completed', 'next_id': 1, 'records': []}}, 'state': {'filter': 'completed', 'next_id': 1, 'records': []}}}]
        for case in cases:
            outward.clear()
            reset_state()
