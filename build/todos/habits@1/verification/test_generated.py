...
CASES = [{'id': 'habits.lifecycle', 'input': {'steps': [{'arguments': {'daily_observation_field': 'daily_observation_field-value', 'recurrence_field': 'recurrence_field-value', 'streak_field': 'streak_field-value', 'title': 'A'}, 'command': 'create'}, {'arguments': {'id': 1}, 'command': 'toggle'}, {'restart': True}]}, 'expected': {'results': [{'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': False, 'daily_observation_field': 'daily_observation_field-value', 'id': 1, 'recurrence_field': 'recurrence_field-value', 'streak_field': 'streak_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'daily_observation_field': 'daily_observation_field-value', 'id': 1, 'recurrence_field': 'recurrence_field-value', 'streak_field': 'streak_field-value', 'title': 'A'}]}}, {'error': None, 'result': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'daily_observation_field': 'daily_observation_field-value', 'id': 1, 'recurrence_field': 'recurrence_field-value', 'streak_field': 'streak_field-value', 'title': 'A'}]}}], 'state': {'filter': 'all', 'next_id': 2, 'records': [{'completed': True, 'daily_observation_field': 'daily_observation_field-value', 'id': 1, 'recurrence_field': 'recurrence_field-value', 'streak_field': 'streak_field-value', 'title': 'A'}]}}}]
