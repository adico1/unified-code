...
- `.coverage` · `evidence` · `ok` · `5a0079b2e4d8cac7`
...
- `UEM_SPEC.md` · `handwritten-pending` · `standard.gap` · `6b26b0764348b17e`
...
- `c/core/stateful.c` · `physical-host-boundary` · `ok` · `42596e3affdef15f`
...
- `c/targets/manifests/l12_report_x86_64.json` · `evidence` · `ok` · `2e551948dbfdd8ec`
...
- `c/tests/core_coverage_harness.c` · `handwritten-pending` · `standard.gap` · `00349e9b8efff005`
...
- `coverage.json` · `evidence` · `ok` · `c0c8594146888656`
- `coverage_py.json` · `evidence` · `ok` · `bdd9a8f5d745b67b`
...
- `tests/test_l13_coverage.py` · `handwritten-pending` · `standard.gap` · `56d875967b4c5517`
...
- `unified/machine/l11.py` · `handwritten-pending` · `standard.gap` · `ea3e82ec9a5a3a02`
...
- `unified/machine/stateful.py` · `handwritten-pending` · `standard.gap` · `2e06be30c4fdb4da`
