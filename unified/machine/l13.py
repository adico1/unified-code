...
def _run_branch_ledger() -> dict:
    ...
    return {
        ...
        "baseline": "c/tests/branch_baseline.json",
        ...
        "baseline_open": data.get("baseline_open"),
        "resolved_by_test": data.get("resolved_by_test"),
        "removed_by_refactor": data.get("removed_by_refactor"),
        "new_arcs": data.get("new_arcs"),
        "remapped_arcs": data.get("remapped_arcs"),
        "ambiguous_arcs": data.get("ambiguous_arcs"),
        "current_open": data.get("current_open"),
        "still_baseline_open": data.get("still_baseline_open"),
        "resolved_arcs": data.get("resolved_by_test"),  # alias
        "equation_holds": (data.get("reconciliation") or {}).get("holds"),
        "conservation_holds": (data.get("baseline_conservation") or {}).get("holds"),
