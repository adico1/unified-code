...
def render_source(seed):
    ...
    lines = [
        ...
        *(("def _confirm(*arguments, **options):", "    from tkinter.messagebox import askyesno", "    return askyesno(*arguments, **options)", "") if confirmations else ()),
        "",
        "def state_path():",
    ...
    lines.extend(
        [
            ...
            *(("    global Notebook, Scrollbar, Treeview", "    from tkinter.ttk import Notebook, Scrollbar, Treeview") if table else ()),
            "    _inputs.clear()",
            "    _collections.clear()",
            "    _details.clear()",
            "    _buttons.clear()",
